...
gEllipse::gEllipse(QObject* parent) : QObject(parent), QGraphicsEllipseItem() {
    setData(1, "figure");
}


void gEllipse::adjustLines() {
...
bool gEllipse::checkLines(QLineF testLine) {
...
QGraphicsLineItem* gEllipse::lineTo(gEllipse* targetItem) {

    gEllipse* pressedItem = this;
